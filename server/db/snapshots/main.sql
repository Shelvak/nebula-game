...
CREATE TABLE `fow_galaxy_entries` (
  ...
  CONSTRAINT `fow_galaxy_entries_ibfk_3` FOREIGN KEY (`alliance_id`) REFERENCES `alliances` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `units` (
  ...
  `type` enum('Avenger','Azure','BossShip','ConvoyShip','Crow','Cyrix','Dart','Demosis','Dirac','Glancer','Gnat','Gnawer','Jumper','Mantis','Mdh','MobileScreamer','MobileThunder','MobileVulcan','Mule','Rhyno','Scorpion','Seeker','Shocker','Spudder','Thor','Trooper','Zeus') NOT NULL,
...
-- Dump completed on 2012-05-12 16:42:39
