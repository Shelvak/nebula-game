...
CREATE TABLE `construction_queue_entries` (
  ...
  CONSTRAINT `construction_queue_entries_ibfk_2` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2011-11-23 12:14:58
