...
public class PathfinderTest {
  ...
  public void testFindPlanetToSameSSPlanetDirect() {
    ...
    Set expResult = new LinkedHashSet();
    expResult.add(new Location(fromSolarSystem.id, spacemule.objects.Location.SOLAR_SYSTEM,
      1, 0));
    expResult.add(new Location(fromSolarSystem.id, spacemule.objects.Location.SOLAR_SYSTEM,
      2, 0));
    expResult.add(new Location(fromSolarSystem.id, spacemule.objects.Location.SOLAR_SYSTEM,
      3, 0));
    expResult.add(new Location(2, spacemule.objects.Location.PLANET,
      null, null));
  ...
  public void testFindPointToSSPlanetDirect() {
    ...
    expResult.add(new Location(fromSolarSystem.id, spacemule.objects.Location.SOLAR_SYSTEM,
      1, 90));
    expResult.add(new Location(to.getId(), spacemule.objects.Location.PLANET,
      null, null));
  ...
  public void testFindPlanetToOtherSSPlanet() {
    ...
    expResult.add(new Location(galaxyId,
      spacemule.objects.Location.GALAXY, 0, 0));
    expResult.add(new Location(galaxyId,
      spacemule.objects.Location.GALAXY, 1, 1));
    expResult.add(new Location(galaxyId,
      spacemule.objects.Location.GALAXY, 2, 2));
    expResult.add(new Location(galaxyId,
      spacemule.objects.Location.GALAXY, 3, 2));
  ...
  public void testFindPlanetToOtherSSPlanet2() {
    ...
    expResult.add(new Location(fromSolarSystem.id,
      ...
      2, 0));
    expResult.add(new Location(galaxyId, 
      spacemule.objects.Location.GALAXY, -1, 0));
    expResult.add(new Location(galaxyId,
      spacemule.objects.Location.GALAXY, 0, 0));
    expResult.add(new Location(galaxyId,
      spacemule.objects.Location.GALAXY, 1, 0));
    ...
    expResult.add(new Location(toSolarSystem.id,
      spacemule.objects.Location.SOLAR_SYSTEM,
      1, 0));
    expResult.add(new Location(toPlanetId, spacemule.objects.Location.PLANET,
      null, null));
