...
load_times[:gems] = Benchmark.realtime do
  require 'rubygems'
...
# initialization
load_times[:plugins] = Benchmark.realtime do
...
load_times[:autoloader] = Benchmark.realtime do
  (
    ["#{ROOT_DIR}/lib/server"] +
...
load_times[:logger] = Benchmark.realtime do
...
load_times[:signals] = Benchmark.realtime do
  begin
    trap("HUP") do
...
config_dir = nil
load_times[:game_config] = Benchmark.realtime do
...
#
load_times[:autoloader_files] = Benchmark.realtime do
  [
    "#{ROOT_DIR}/lib/server",
...
load_times[:activerecord_config] = Benchmark.realtime do
...
load_times[:server_preloader] = Benchmark.realtime do
  Dir[
...
load_times[:config_initializers] = Benchmark.realtime do
...
load_times[:event_handlers] = Benchmark.realtime do
