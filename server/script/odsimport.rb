...
MAIN_TITLE_PROPS = [
  ...
  [/required planets$/, ".planets.required"],
  ...
  [/critical mod$/, ".mod.critical"],
  [/absorption mod$/, ".mod.absorption"],
...
sections["combat"]["critical.multiplier"] =
  sections["combat"]["absorption.divider"] = sheet[29][1].to_f
