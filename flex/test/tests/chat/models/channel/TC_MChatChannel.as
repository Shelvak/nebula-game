package tests.chat.models.channel
{
   ...
   public class TC_MChatChannel extends TC_BaseMChatChannel
   {
      ...
      [Test]
      public function numberOfUnreadMessages_whenChannelIsVisible(): void {
         channel.visible = true;
         assertThat(
            "should be no unread messages when there aren't any messages",
      ...
      [Test]
      public function numberOfUnreadMessages_whenChannelBecomesVisible(): void {
         channel.visible = false;
         channel.receiveMessage(message);
