package controllers.alliances
{
   ...
   public class AlliancesCommand extends CommunicationCommand
   {
      ...
      /**
       * @see controllers.alliances.actions.GiveAwayAction
       */
      public static const GIVE_AWAY:String = "alliances|give_away";

      /**
       * @see controllers.alliances.actions.TakeOverAction
       */
      public static const TAKE_OVER:String = "alliances|take_over";
