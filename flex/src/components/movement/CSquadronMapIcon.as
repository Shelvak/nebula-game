package components.movement
{
   ...
   public class CSquadronMapIcon extends Group implements ICleanable
   {
      ...
      private var _commanded: Boolean;
      public function set commanded(value: Boolean): void {
         if (_commanded != value) {
            _commanded = value;
            f_commandedChanged = true;
            invalidateProperties();
         }
      }
      ...
      private var f_commandedChanged: Boolean = true;
      ...
      protected override function commitProperties(): void {
         ...
         if (_levelIcon && (f_selectedChanged
                               || f_squadronChanged
                               || f_commandedChanged
                               || f_underMouseChanged)) {
            if (_squadron) {
               if (_underMouse || _selected || _commanded) {
