package models.factories
{
   ...
   public class SquadronFactory
   {
      ...
      public static function createHostileRoute(squad:MSquadron,
         ...
         if (route.currentLocation.isSSObject) {
            route.sourceLocation = route.currentLocation;
         }
      ...
      public static function fromObject(data: Object): MSquadron {
         var currentLoc: LocationMinimal =
                Objects.create(LocationMinimal, data.current);
