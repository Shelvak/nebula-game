package models.quest.slides
{
   public final class SlidesConfiguration
   {
      ...
      public static const CLAIM_REWARD:String = "ClaimReward";
      public static const CLAIM_REWARD_RC:String = "ClaimRewardRC";
      ...
      private static const BACKGROUNDS_WITHOUT_LOC:Array = [
         ...
         KEY_RADAR2, KEY_RESOURCES, KEY_ZETIUM_TILE, CLAIM_REWARD, CLAIM_REWARD_RC
      ];
