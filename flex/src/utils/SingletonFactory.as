package utils
{
   ...
   public class SingletonFactory extends InstanceFactory
   {
      ...
      public function SingletonFactory(lock:Class)
      {
         ...
         if(!lock is SingletonLock) throw new Error("Invalid use of SingletonFactory constructor, " +
       ...
       */
      client_internal static function registerSingletonInstance(type:Class, instanceObj:*) : void
      {
      ...
      client_internal function registerSingletonInstance(type:Class, instanceObj:*) : void
      {
         ...
         if (!(instanceObj is type))
         {
            throw new ArgumentError("[param instanceObj] " + instanceObj +
                                    " must be an instance of class " + type);
         }
