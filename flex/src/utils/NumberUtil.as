package utils
{
   ...
   public final class NumberUtil
   {
       ...
       *
       **/
      public static function toShortString(number: Number,
                                           roundingPrecision: int = 1): String {
         ...
         return (Math.round(number / divider * rounder) / rounder).toString()
                   + suffix;
      }
       ...
       */
      public static function compareFloat(value1: Number,
                                          value2: Number,
                                          epsilon: Number = 0): int {
       ...
       * @see #compareFloat()
       */
      public static function lessThan(value1: Number, value2: Number,
                                      epsilon: Number = 0): Boolean {
       ...
       * @see #compareFloat()
       */
      public static function greaterThan(value1: Number,
                                         value2: Number,
                                         epsilon: Number = 0): Boolean {
         return compareFloat(value1, value2, epsilon) > 0;
      }
       ...
       * @see #compare()
       */
      public static function equal(value1: Number,
                                   value2: Number,
                                   epsilon: Number = 0): Boolean {
         return compareFloat(value1, value2, epsilon) == 0;
      }
